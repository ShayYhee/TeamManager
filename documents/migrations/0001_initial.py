# Generated by Django 5.1.7 on 2025-03-25 21:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('BDA', 'Business Development Assistant'), ('BDM', 'Business Development Manager')], default='BDA', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('document_type', models.CharField(choices=[('approval', 'Approval Letter'), ('sla', 'SLA Document')], max_length=20)),
